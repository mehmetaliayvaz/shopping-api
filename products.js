export default [
  ...
  {
    id: 8,
    title: `Ve-Ge Copier Bond A4 80 G/m² 2.500'lü Fotokopi Kağıdı 5'li Paket`,
    category: "kirtasiye-ofis",
    price: 355,
  ...
  {
    id: 9,
    title: `Dolu 8086 Sahara Uzaktan Kumanlı Akülü Araba`,
    category: "oyuncak",
    price: 1999,
    description: `Yaş Aralığı: 3 yaş ve üzeri
    Maksimum Kapasite: 35 kg, Hız: 3,5 / Saat hız
    Ürün ölçüleri: 69 x 103 x 73 cm, 12 V Akü,12 V Şarj Cihazı
  ...
  {
    id: 10,
    title: `Dede Art Craft Inşaat Kinetik Kum Ev Seti 750 Gr.`,
    category: "oyuncak",
    price: 199,
    description: `Art Craft İnşaat Kinetik Kum Ev Seti 750 Gr. Kinetik Kum deniz kumu ile oynamanın muhteşemliğini evinize kadar getirecek,
    hem de dağılmadan kirletmeden!
  ...
  {
    id: 11,
    title: `Dede Multi Blocks 120 Parça`,
    category: "oyuncak",
    price: 299,
    description: `Bloklar çocukların el becerilerini geliştirir.
    Sınırsız oluşturma ve inşa etme seçenekleri geliştirme özelliğini arttırır ve hayal gücünü geliştirir.
  ...
  {
    id: 12,
    title: `Bioderma Sensibio Foaming Gel 500 ml`,
    category: "kozmetik",
    price: 290,
  ...
  {
    id: 13,
    title: `The Purest Solutions 24 Saat Etkili Günlük Yoğun Nemlendirici Bakım Kremi TPS202`,
    category: "kozmetik",
    price: 254,
